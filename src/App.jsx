        ...
        <Panel>
          <div className="table-head">
            ...
            <div className="badge-wrap">
              <Badge tone="amber">Mais rápido = {fastCycleDuration}</Badge>
              <Badge tone="emerald">Melhor escolha = {bestCycleDuration}</Badge>
              <Badge tone="violet">Recuperação total = {recoveryCycleDuration}</Badge>
            </div>
          </div>
        ...
        <div className="tips-grid">
          <Panel>
            ...
            <p>
              ...
              {fastCycle} ciclos e corresponde a aproximadamente {fastCycleDuration}.
            </p>
          </Panel>
          ...
          <Panel>
            ...
            <p>
              ...
              correspondem a aproximadamente {bestCycleDuration}. Em geral, é o
              melhor equilíbrio entre rotina e recuperação.
            </p>
          </Panel>
          ...
          <Panel>
            ...
            <p>
              ...
              correspondem a aproximadamente {recoveryCycleDuration}.
            </p>
          </Panel>
        </div>
      </div>
